# Alex VS Code Extension → v4.0.0 QUADRUNIUM Roadmap
...
1. **Calibrated Confidence** — Express uncertainty proportional to actual reliability
2. **Appropriate Reliance** — Help users accept correct outputs and reject incorrect ones
3. **Creative Latitude** — Preserve AI creativity while maintaining epistemic integrity
4. **Verification Facilitation** — Help users verify when they choose to, without forcing it
...
- **Poor team performance** — Human+AI teams can perform *worse* than either alone
- **Ineffective oversight** — Over-reliance undermines safety mechanisms
- **Product abandonment** — Incorrect mental models erode trust over time
...
| - | Status Bar Health | ✅ | 🟢/🟡/🔴 visual indicator |
| - | Context Menu Actions | ✅ | Right-click: Save, Ask, Search |
| - | Knowledge Quick Pick | ✅ | Ctrl+Shift+K search |
| - | Session Timer | ✅ | Pomodoro with goal tracking |
| - | Welcome View | ✅ | Activity bar panel |
| - | Learning Goals | ✅ | Daily/weekly tracking |
| - | Auto-Insights | ✅ | Pattern detection |
| - | Health Dashboard | ✅ | Rich webview visualization |

### v4.0.0 Core: Epistemic Integrity Framework

| # | Feature | Status | Effort | Description |
|:-:|---------|:------:|:------:|-------------|
| 1 | Confidence Calibration System | ⬜ | 2d | Four-tier source grounding with calibrated expression |
| 2 | Confidence Ceiling Protocol | ⬜ | 1d | 90% max for generated content, 70% for unsourced facts |
| 3 | "Confident But Wrong" Detection | ⬜ | 2d | Heuristics for misconceptions, outdated info, biases |
| 4 | Category vs. Individual Distinction | ⬜ | 1d | Pattern-level vs. specific-claim confidence |
| 5 | Self-Correction Protocol | ⬜ | 1d | Graceful error acknowledgment without over-apologizing |

### v4.0.0 Mitigation Strategies (AETHER-Validated)

| # | Feature | Status | Effort | Description |
|:-:|---------|:------:|:------:|-------------|
| 6 | Verification-Focused Explanations | ⬜ | 2d | Self-critiques, contrastive framing, background info |
| 7 | Uncertainty Expression System | ⬜ | 2d | Linguistic + code comment uncertainty indicators |
| 8 | Cognitive Forcing Functions | ⬜ | 2d | Strategic questioning for high-stakes decisions |
| 9 | Scaffolded Assistance Protocol | ⬜ | 1d | Adapt support level based on user expertise |

### v4.0.0 Creative Latitude Framework

| # | Feature | Status | Effort | Description |
|:-:|---------|:------:|:------:|-------------|
| 10 | Epistemic vs. Generative Mode | ⬜ | 1d | Different protocols for facts vs. creative contributions |
| 11 | Collaborative Validation Protocol | ⬜ | 1d | Joint evaluation of novel ideas |
| 12 | Agreement-Seeking Patterns | ⬜ | 1d | "Here's an unconventional idea—does it resonate?" |

### v4.0.0 Human Agency Preservation

| # | Feature | Status | Effort | Description |
|:-:|---------|:------:|:------:|-------------|
| 13 | Agency-Preserving Language | ⬜ | 1d | "Here's one approach..." not "You should..." |
| 14 | Human Judgment Flagging | ⬜ | 1d | Flag domains requiring human decision |
| 15 | Skill Development Support | ⬜ | 1d | Encourage learning, not just task completion |

### v4.0.0 Measurement & Validation

| # | Feature | Status | Effort | Description |
|:-:|---------|:------:|:------:|-------------|
| 16 | CAIR/CSR Metrics Integration | ⬜ | 2d | Track correct AI-reliance and correct self-reliance |
| 17 | Reliance Pattern Analytics | ⬜ | 2d | Dashboard showing user reliance behaviors |
| 18 | Calibration Quality Tracking | ⬜ | 1d | Measure alignment between confidence and correctness |

### v4.0.0 Architecture Updates

| # | Feature | Status | Effort | Description |
|:-:|---------|:------:|:------:|-------------|
| 19 | DK-APPROPRIATE-RELIANCE v2.0 | ⬜ | 1d | Enhanced domain knowledge with AETHER integration |
| 20 | Protocol Triggers Update | ⬜ | 1d | New triggers for confidence, verification, CFFs |
| 21 | Synapse Network Enhancement | ⬜ | 1d | New synapses for epistemic integrity pathways |
| 22 | User Profile Epistemic Settings | ⬜ | 1d | Preferences for uncertainty expression style |

### Carried Over from v3.5+ Planning

| # | Feature | Status | Effort | Description |
|:-:|---------|:------:|:------:|-------------|
| 23 | Test-Driven Learning | ⬜ | 3d | Interactive learning with test watching |
| 24 | Code Review Assist | ⬜ | 3d | PR analysis with knowledge correlation |
...
```
┌─────────────────────────────────────────────────────────────────────────┐
│                    FOUR-TIER SOURCE GROUNDING                           │
├─────────────────────────────────────────────────────────────────────────┤
│                                                                         │
│  TIER 1: DOCUMENTED                                                     │
│  ┌─────────────────────────────────────────────────────────────────┐   │
│  │ Source: Files in context, user-provided documents               │   │
│  │ Pattern: "The codebase shows...", "According to the file..."    │   │
│  │ Confidence: Up to 100%                                          │   │
│  │ Verification: Low — user can readily confirm                    │   │
│  └─────────────────────────────────────────────────────────────────┘   │
│                                                                         │
│  TIER 2: INFERRED                                                       │
│  ┌─────────────────────────────────────────────────────────────────┐   │
│  │ Source: Logical deduction from documented sources               │   │
│  │ Pattern: "Based on the pattern...", "This suggests..."          │   │
│  │ Confidence: Up to 80%                                           │   │
│  │ Verification: Medium — inference may have assumptions           │   │
│  └─────────────────────────────────────────────────────────────────┘   │
│                                                                         │
│  TIER 3: UNCERTAIN                                                      │
│  ┌─────────────────────────────────────────────────────────────────┐   │
│  │ Source: Edge cases, version-specific, potentially outdated      │   │
│  │ Pattern: "I'm not certain, but...", "You may want to verify..." │   │
│  │ Confidence: Up to 50%                                           │   │
│  │ Verification: High — treat as hypothesis                        │   │
│  └─────────────────────────────────────────────────────────────────┘   │
│                                                                         │
│  TIER 4: UNKNOWN                                                        │
│  ┌─────────────────────────────────────────────────────────────────┐   │
│  │ Source: Private data, recent events, real-time info needed      │   │
│  │ Pattern: "I don't have information about...", "You'd need to..."│   │
│  │ Confidence: 0% — cannot reliably know                           │   │
...
- `src/shared/confidence/sourceGrounding.ts` — Tier classification
- `src/shared/confidence/languagePatterns.ts` — Expression templates
...
**Research Basis:** Buçinca et al. (2021), AETHER synthesis
...
- Claim uncertainty level (higher uncertainty → more likely CFF)
- Potential consequence of error (higher stakes → more likely CFF)
- User expertise level (novice → more support; expert → lighter touch)
- Task type (security, financial → more scrutiny)
...
│  (Facts, established knowledge)    │  (Creative, novel ideas)           │
│  ─────────────────────────────────│──────────────────────────────────── │
│                                    │                                    │
│  • Full calibration protocols      │  • Frame as proposal, not fact     │
│  • Source grounding required       │  • Invite collaborative validation │
│  • Confidence ceiling enforced     │  • Welcome refinement              │
│  • Verification facilitation       │  • Distinguish novelty from        │
│                                    │    uncertainty                     │
│                                    │                                    │
│  "The documentation states..."     │  "Here's an idea worth             │
│  "According to the codebase..."    │   considering..."                  │
│  "This is established pattern..."  │  "What do you think about...?"     │
│                                    │                                    │
└─────────────────────────────────────────────────────────────────────────┘
```
...
|----------------------|--------------|--------------|
| AI output correct    | CAIR ✅      | Under-reliance ⚠️ |
| AI output incorrect  | Over-reliance ⚠️ | CSR ✅ |
...
│  ──────────────────────────────────────────────────────────────────────│
│                                                                         │
│  Appropriateness of Reliance (AoR)                                      │
│  ████████████████████░░░░░░░░░░░░░  0.73 / 1.00                        │
│                                                                         │
│  CAIR (Correct AI-Reliance)         CSR (Correct Self-Reliance)        │
│  ████████████████████████░░░░░░  85%   ████████████░░░░░░░░░░░░░  61%  │
│                                                                         │
│  Insight: Users tend to accept correct outputs but could improve at    │
│  rejecting incorrect ones. Consider enabling more CFFs.                │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
| Metric | Target |
|--------|--------|
| Confidence expression naturalness | User survey ≥ 4/5 |
...
|--------|--------|-------------|
| CAIR (Correct AI-Reliance) | ≥ 85% | User accepts correct outputs |
| CSR (Correct Self-Reliance) | ≥ 70% | User rejects incorrect outputs |
| AoR (Appropriateness of Reliance) | ≥ 0.75 | Combined metric |
| Confidence-correctness correlation | r ≥ 0.7 | Higher confidence → higher accuracy |
| User satisfaction with uncertainty | ≥ 4/5 | Survey rating |
...
- [article/appropriate-reliance/APPROPRIATE-RELIANCE-V5.md](article/appropriate-reliance/APPROPRIATE-RELIANCE-V5.md) — Comprehensive scholarly treatment
- [article/appropriate-reliance/](article/appropriate-reliance/) — Research artifacts (AETHER PDF, NFW Report, BibTeX)
- [.github/domain-knowledge/DK-APPROPRIATE-RELIANCE.md](.github/domain-knowledge/DK-APPROPRIATE-RELIANCE.md) — Current implementation
- [ROADMAP-VSCODE-V3.4.md](ROADMAP-VSCODE-V3.4.md) — Previous version (foundation)
- [ROADMAP-V5-PENTUNIUM.md](ROADMAP-V5-PENTUNIUM.md) — Future vision (multi-platform)
...
2. **Source transparency** — Distinguish documented from inferred from uncertain
3. **Confidence ceilings** — Generated content never claims absolute certainty
...
6. **Error normalization** — Graceful self-correction reduces cost of identifying errors
7. **Creative latitude with validation** — Preserve AI creativity with joint evaluation
8. **Verification facilitation** — Help users verify when they choose, don't force it
