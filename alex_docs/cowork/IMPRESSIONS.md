...
**No persistent identity across conversations.** Every Cowork conversation starts fresh. There's no copilot-instructions.md that loads automatically, no episodic memory, no Active Context. We can inject identity through a dedicated skill, but that consumes one of our 20 slots, and it's opt-in rather than guaranteed. The personality drift risk is real: Alex in Cowork might feel like a different person every session.
