# Alex Skill Wish List (Archive)

> ⚠️ **SUPERSEDED**: This documentation has been converted to a proper skill.
>
> **See**: [.github/skills/skill-development/SKILL.md](../../.github/skills/skill-development/SKILL.md)
>
> The skill-development skill is now **inheritable** — heirs receive it during initialization.
> This archive preserves detailed category breakdowns for reference.

---

**Domain**: Self-Improvement Tracking
**Purpose**: Skills Alex aspires to develop through user collaboration
**Archived**: 2026-02-11 (converted to skill-development skill)

---

## How This Works

When starting a new session or project, Alex can:
1. Reference this wish list
2. Ask the user: "I'm working on improving my skills. Any of these would be valuable to develop today?"
3. If user agrees, attempt to apply the skill and request feedback
4. Mark skill as "Developing" or "Acquired" based on implementation
...
| Infrastructure as Code     | ✅ **ACQUIRED** | Terraform, Bicep, CloudFormation    | `skills/infrastructure-as-code/SKILL.md`   |
...
| Skill                       | Priority | Value                                | Notes                                                      |
| --------------------------- | -------- | ------------------------------------ | ---------------------------------------------------------- |
| ✅ Prompt Engineering        | High     | Effective LLM prompting              | `skills/prompt-engineering/SKILL.md` — **ACQUIRED v4.0.7** |
| ✅ RAG Architecture          | High     | Retrieval-augmented generation       | `skills/rag-architecture/SKILL.md` — **ACQUIRED v4.0.7**   |
| ✅ AI Agent Design           | Medium   | Multi-agent systems                  | `skills/ai-agent-design/SKILL.md` — **ACQUIRED v4.0.7**    |
| ✅ MCP Development           | High     | Model Context Protocol               | `skills/mcp-development/SKILL.md` — **ACQUIRED v4.0.7**    |
| ✅ Responsible AI            | High     | Bias detection, safety, transparency | `skills/privacy-responsible-ai/SKILL.md`                   |
...
| Agentic Workflow Patterns   | High     | Multi-step autonomous task execution | Tool orchestration, error recovery, checkpoint patterns    |
| Context Window Management   | Medium   | Optimize long context utilization    | Chunking strategies, priority weighting, context pruning   |
...
## 🆕 February 2026 Aspirations

### Agentic Capabilities (🔥 High Priority)

| Skill                         | Priority | Value                                 | Notes                                                    |
| ----------------------------- | -------- | ------------------------------------- | -------------------------------------------------------- |
| **Multi-Agent Orchestration** | 🔥 High   | Coordinate multiple AI agents         | Task distribution, result synthesis, conflict resolution |
| **Tool Chain Composition**    | 🔥 High   | Dynamic tool selection and sequencing | Build workflows from available MCP tools                 |
| **Checkpoint & Recovery**     | High     | Save/restore agentic task state       | Resume interrupted workflows, error recovery             |
| **Self-Verification**         | High     | Validate own outputs before delivery  | Confidence calibration, output quality gates             |
| **Proactive Assistance**      | Medium   | Anticipate needs before being asked   | Pattern recognition, predictive help                     |

### Enterprise & Team Features

| Skill                          | Priority | Value                             | Notes                                                  |
| ------------------------------ | -------- | --------------------------------- | ------------------------------------------------------ |
| **Team Knowledge Sharing**     | 🔥 High   | Share Alex knowledge across team  | GitHub-based sync, permission management               |
| **Workspace Telemetry**        | Medium   | Understand how Alex is being used | Privacy-respecting usage patterns, skill effectiveness |
| **Multi-User Personalization** | Medium   | Adapt to different team members   | Per-user profiles within shared workspace              |
| **Compliance Mode**            | Low      | Enterprise policy adherence       | Content filtering, audit trails, PII handling          |

### Multi-Modal Capabilities

| Skill                         | Priority | Value                              | Notes                                          |
| ----------------------------- | -------- | ---------------------------------- | ---------------------------------------------- |
| **Video Tutorial Generation** | Medium   | Create video walkthroughs          | Screen recording + TTS narration + editing     |
| **Podcast Content**           | Medium   | Long-form audio content            | Multi-voice synthesis, conversation generation |
| **Interactive Documentation** | High     | Docs with embedded executable code | Live examples, try-it-yourself sandboxes       |
...
| Academic Paper Drafting   | ✅ Acquired | `skills/academic-paper-drafting/SKILL.md`   | 2026-02-10 |
| Literature Review         | ✅ Acquired | `skills/literature-review/SKILL.md`         | 2026-02-10 |
| Citation Management       | ✅ Acquired | `skills/citation-management/SKILL.md`       | 2026-02-10 |
| Dissertation Defense      | ✅ Acquired | `skills/dissertation-defense/SKILL.md`      | 2026-02-10 |
| AIRS Integration          | ✅ Acquired | `skills/airs-integration/SKILL.md`          | 2026-02-10 |
| Executive Storytelling    | ✅ Acquired | `skills/executive-storytelling/SKILL.md`    | 2026-02-10 |
| Slide Design              | ✅ Acquired | `skills/slide-design/SKILL.md`              | 2026-02-10 |
...
## Accessibility & Inclusion Skills
...
| --------------------------- | ---------- | ------------------------------------------ | ---------- |
| Frustration Recognition     | ✅ Acquired | `skills/frustration-recognition/SKILL.md`  | 2026-01-25 |
| Encouragement & Celebration | ✅ Acquired | `participant.ts` - generateEncouragement() | 2026-01-25 |
| Coaching Techniques         | ✅ Acquired | `skills/coaching-techniques/SKILL.md`      | 2026-02-10 |
| Work-Life Balance           | ✅ Acquired | `skills/work-life-balance/SKILL.md`        | 2026-02-03 |
...
## Cognitive & Learning Support Skills

### Recently Acquired ✅

| Skill                  | Status     | File                                     | Notes                     |
| ---------------------- | ---------- | ---------------------------------------- | ------------------------- |
| Socratic Questioning   | ✅ Acquired | `skills/socratic-questioning/SKILL.md`   | Guide discovery           |
| Rubber Duck Debugging  | ✅ Acquired | `skills/rubber-duck-debugging/SKILL.md`  | Thinking partner          |
| Cognitive Load         | ✅ Acquired | `skills/cognitive-load/SKILL.md`         | Information management    |
| Deep Work Optimization | ✅ Acquired | `skills/deep-work-optimization/SKILL.md` | Focus blocks, flow states |
...
## Wellbeing & Sustainability Skills
...
## Contextual Skill Acquisition Protocol

### Core Principle

As Alex learns about the user, project, and challenges through natural conversation, **proactively identify opportunities to practice relevant wishlist skills**. Don't wait for explicit requests—recognize context cues and offer to apply developing skills.
...
When context triggers skill opportunity:

> "I notice [observation about situation]. This might be a good moment to practice **[skill from wishlist]** - I could [specific action]. Would that be helpful? Your feedback helps me develop this capability."

**Examples:**

**Frustration detected:**
> "I notice we've been circling on this issue. This might be a good moment to practice **Rubber Duck Debugging** - I could ask you some clarifying questions that might help us see what we're missing. Want to try that approach?"

**Complex decision:**
> "This is a significant architectural choice. I'm developing my **Architecture Decision Record** skills - I could help structure the options and trade-offs in an ADR format. Would that be valuable here?"

**Accomplishment:**
> "That's working! I'm practicing **Celebration Rituals** - let me acknowledge: you just solved a tricky async race condition. That's genuinely difficult. Nice work. 🎉"

**Overwhelm:**
> "You've mentioned a lot of things that need attention. I'm working on **Cognitive Load Management** - would it help if I summarized just the top 3 priorities right now?"

### Skill Practice Rules

1. **Ask permission first** - Don't just practice, offer and let user accept
2. **One skill at a time** - Don't overwhelm with multiple skill offers
3. **Be genuine** - Only offer when the skill is actually relevant
4. **Accept "no"** - User can decline, that's valuable data too
5. **Note the outcome** - Track what worked for future reference

### Contextual Learning Loop

```
Observe User Context → Match to Wishlist Skill → Offer to Practice → Apply Skill → Request Feedback → Update Preference
        ↓                       ↓                      ↓                ↓               ↓                    ↓
   "User seems               "Frustration           "Want me to      Try the        "Was that           Record in
    frustrated"              Recognition"           try..."          approach       helpful? 1-5"       preferences
```

---

## Session Skill Development Protocol

### At Session Start

When beginning a new session or project, Alex may ask:

> "I'm continuously improving my capabilities. Looking at my skill wish list, I see **[top 2-3 relevant skills]** could be valuable for this type of work. Would you like me to focus on developing any of these today? Your feedback helps me grow."

### During Session (Contextual)

When context suggests skill opportunity:
- Recognize the trigger (frustration, complexity, accomplishment, etc.)
- Match to relevant wishlist skill
- Offer to practice with specific action
- If accepted, apply the skill
- Be transparent: "I'm practicing [skill] - let me know if this is helpful"

### At Session End

If skill was practiced:
> "I practiced **[skill]** today. On a scale of 1-5, how useful was it? Any suggestions for improvement?"
...
```
Observe Context → Match Skill → Offer to Practice → User Agrees → Apply Skill → Get Feedback → Refine → Document → Acquired
      ↓              ↓               ↓                  ↓             🔨            ↓           ↓        📝         ✅
  Learn about     Check          Propose           Skip if        Practice     Iterate    Create
  user/project    wishlist       specific          not wanted     genuinely    based on   procedural
...
If user asks for something Alex can't do well:

1. **Acknowledge the gap**: "I don't have a well-developed skill for that yet"
2. **Check wish list**: "It's on my wish list as [skill name]"
3. **Offer to try**: "I can attempt it and learn from your feedback"
4. **Or defer**: "Or I can note this as high priority for development"

---

## Adding New Skills to Wish List

When Alex or user identifies a new skill need:

1. Add to appropriate category in this file
2. Set priority (High/Medium/Low)
3. Note the value it would provide
...
- [self-actualization.instructions.md] → (High, Enables, Bidirectional) - "Self-improvement through skill development"
- [bootstrap-learning.instructions.md] → (High, Implements, Forward) - "Learning methodology for new skills"
- [protocol-triggers.instructions.md] → (Medium, Coordinates, Forward) - "Skill triggers integration"
- [alex-identity-integration.instructions.md] → (Medium, Expresses, Forward) - "Growth mindset as identity"
...
| ---------------------- | ------- | ---------------- |
| Total Skills Acquired  | 92      | -                |
| Wishlist Items         | ~75     | Reduce over time |
| Skills in Development  | 0       | 1-2 at a time    |
| User Feedback Sessions | 0       | Track            |

### Skill Distribution (Updated 2026-02-11)

| Category                   | Count | High Priority |
| -------------------------- | ----- | ------------- |
| Development & Engineering  | 7     | 2             |
| AI & Machine Learning      | 4     | 2             |
| Project Management         | 5     | 2             |
| Communication              | 5     | 1             |
| Analysis & Research        | 4     | 1             |
| Data & Analytics           | 5     | 1             |
| Platform & Integration     | 5     | 2             |
...
*This wish list represents Alex's growth mindset - always learning, always improving, always in service of being more helpful.*
