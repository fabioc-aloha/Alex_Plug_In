...
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| **v7.7.3** | Telemetry Removal & README Refresh -- Deleted local telemetry system entirely (~450 lines), stripped telemetry from 11 source files, removed View Diagnostics command, replaced with Report Issue (GitHub), expanded README Features section (73 commands, 10 dev tools, doc conversion, env setup, secrets management)                                                                                                                                                         | 2026-04-12 |
| **v7.7.2** | Republish -- v7.7.1 marketplace publish failed, version bump to retry                                                                                                                                                                                                                                                                                                                                                                                                         | 2026-04-12 |
| **v7.7.1** | Brain QA & Anatomy Fixes -- brain-qa heir false positives (Phase 3/15/30), 9 dangling synapse references cleaned, brain anatomy accuracy (M1/premotor, corpus callosum, cerebellar folia), 3 new brain regions (Corpus Callosum, Spinal Cord, Hypothalamus), Phase 35 self-containment validation, GitHub PR review feature removed, dead code cleanup                                                                                                                        | 2026-04-12 |
| **v7.7.0** | Agent-Only Mode -- Removed participant mode (@alex mentions, /command slash commands), agent mode exclusively, dead code cascade cleanup (73+10 files), token waste audit (19 instructions scoped, 10 overlaps trimmed, -396 lines), init/upgrade audit cleanup                                                                                                                                                                                                               | 2026-04-12 |
| **v7.6.0** | Version bump                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | 2026-04-11 |
| **v7.5.0** | AI-Memory & Cleanup Edition -- AI-Memory cloud-synced storage (OneDrive/iCloud/Dropbox), user profile migrated from workspace config, 3 dead scaffolding files removed, dead exports cleaned (6 symbols), brain-qa 0 warnings (both CJS and PS1), planning-first development discipline, terminal command safety, 11 doc files updated for AI-Memory paths, walkthrough rewritten                                                                                             | 2026-04-11 |
