...
import {
    handleMeditateCommand, handleDreamCommand, handleBrainQACommand,
    handleLearnCommand, handleStatusCommand, handleModelCommand,
    handleAzureCommand, handleM365Command, handleProfileCommand,
