/**
 * globalKnowledgeBanner.ts - SVG banner generation for Global Knowledge repository
 *
 * Extracted from globalKnowledgeContent.ts for file-size compliance (P5B).
 * Contains the animated space-station SVG used as the GK repo banner.
 */

export function getAnimatedBannerSvg(): string {
