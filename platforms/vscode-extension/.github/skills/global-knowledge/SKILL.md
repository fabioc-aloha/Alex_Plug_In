...
| `/knowledge save`    | Capture learning from current session     |
| `/knowledge promote` | Promote local knowledge to global pattern |
| `/knowledge status`  | Check GK health and stats                 |
