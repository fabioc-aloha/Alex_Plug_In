...
- [.github/prompts/unified-meditation-protocols.prompt.md] (0.9, enhancement, bidirectional) - "action suggestions in meditation"
- [agents/alex.agent.md] (0.8, integration, outgoing) - "agent command suggestions"
