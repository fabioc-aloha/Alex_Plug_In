...
### Connection Mapping
- [.github/instructions/.github/instructions/dream-state-automation.instructions.md] (Critical, Implements, Bidirectional) - "VS Code extension foundation for lucid processing"
