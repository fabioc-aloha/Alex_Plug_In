...
[![Version](https://img.shields.io/badge/version-5.9.11-0078d4)](https://github.com/fabioc-aloha/Alex_Plug_In)
...
**✨ NEW in v5.9.11**: Post-publish synapse hardening, path normalization (11 relative → full paths), Brain-QA as publish gate.
