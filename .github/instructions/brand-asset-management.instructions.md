...
|----------|------|------|---------|
| `platforms/vscode-extension/assets/logo.svg` | 32x32 | 1.04 KB | Extension icon source |
| `platforms/vscode-extension/assets/logo-mono.svg` | 24x24 | 0.64 KB | Activity bar (currentColor) |
