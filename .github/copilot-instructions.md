...
**Available Skills**: appropriate-reliance, architecture-refinement, ascii-art-alignment, debugging-patterns, git-workflow, learning-psychology, lint-clean-markdown, llm-model-selection, m365-agent-debugging, markdown-mermaid, release-preflight, vscode-extension-patterns, writing-publication
